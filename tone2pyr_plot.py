...
_ = plot_traces(config_file='simulation_config_W+Cai.json', report_path='output/syns_cai.h5', title='cai')
_ = plot_traces(config_file='simulation_config_W+Cai.json', report_path='output/syns_W.h5', title='W')
