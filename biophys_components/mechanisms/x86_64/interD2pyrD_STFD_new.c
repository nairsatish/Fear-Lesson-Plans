...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interD2pyrD_STFD /home/dtanz8/working_repo/PlasticityToy/biophys_components/mechanisms/x86_64/interD2pyrD_STFD_new.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 136 in file interD2pyrD_STFD_new.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dtanz8/working_repo/PlasticityToy/biophys_components/mechanisms/modfiles/interD2pyrD_STFD_new.mod";
static const char* nmodl_file_text = 
