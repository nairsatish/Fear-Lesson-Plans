...
#define nrn_init _nrn_init__pyr2int
#define _nrn_initial _nrn_initial__pyr2int
#define nrn_cur _nrn_cur__pyr2int
#define _nrn_current _nrn_current__pyr2int
...
#define unirand unirand_pyr2int
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyr2int /home/dtanz8/working_repo/PlasticityToy/biophys_components/mechanisms/x86_64/pyr2int.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 149 in file pyr2int.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dtanz8/working_repo/PlasticityToy/biophys_components/mechanisms/modfiles/pyr2int.mod";
static const char* nmodl_file_text = 
