...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na3 /home/mizzou/FR_distribution/biophys_components/mechanisms/x86_64/na3.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/FR_distribution/biophys_components/mechanisms/modfiles/na3.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
  ": Na current \n"
  ": from Jeff M.\n"
