...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 Gfluct2_inh C:/Users/drewa/Desktop/Neural Research/PlasticityToy-master/biophys_components/mechanisms/modfiles/Gfluct_new_inh.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "Gfluct_new_inh.mod";
static const char* nmodl_file_text = 
