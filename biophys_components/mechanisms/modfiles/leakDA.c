...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 leakDA C:/Users/drewa/Desktop/Neural Research/PlasticityToy-master/biophys_components/mechanisms/modfiles/leakDA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "leakDA.mod";
static const char* nmodl_file_text = 
