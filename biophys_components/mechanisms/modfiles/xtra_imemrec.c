...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "area");
 	...
 	ivoc_help("help ?1 xtraimemrec C:/Users/drewa/Desktop/Neural Research/PlasticityToy-master/biophys_components/mechanisms/modfiles/xtra_imemrec.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "xtra_imemrec.mod";
static const char* nmodl_file_text = 
