...
#define nrn_init _nrn_init__pyr2intKIM
#define _nrn_initial _nrn_initial__pyr2intKIM
#define nrn_cur _nrn_cur__pyr2intKIM
#define _nrn_current _nrn_current__pyr2intKIM
#define nrn_jacob _nrn_jacob__pyr2intKIM
#define nrn_state _nrn_state__pyr2intKIM
#define _net_receive _net_receive__pyr2intKIM 
#define release release__pyr2intKIM 
...
#define eta eta_pyr2intKIM
#define omega omega_pyr2intKIM
#define sfunc sfunc_pyr2intKIM
#define unirand unirand_pyr2intKIM
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyr2intKIM /Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/x86_64/pyr2intKIM.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 148 in file pyr2intKIM.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/modfiles/pyr2intKIM.mod";
static const char* nmodl_file_text = 
  ":Pyramidal Cells to Interneuron Cells AMPA+NMDA with local Ca2+ pool\n"
  ":pyrD2interD_STFD from Kim 2013\n"
  "NEURON {\n"
  "	POINT_PROCESS pyr2intKIM\n"
  "	USEION ca READ eca	\n"
