...
#define nrn_init _nrn_init__pyr2pyrFENG
#define _nrn_initial _nrn_initial__pyr2pyrFENG
#define nrn_cur _nrn_cur__pyr2pyrFENG
#define _nrn_current _nrn_current__pyr2pyrFENG
#define nrn_jacob _nrn_jacob__pyr2pyrFENG
#define nrn_state _nrn_state__pyr2pyrFENG
#define _net_receive _net_receive__pyr2pyrFENG 
#define release release__pyr2pyrFENG 
...
#define DA2 DA2_pyr2pyrFENG
#define DA1 DA1_pyr2pyrFENG
#define eta eta_pyr2pyrFENG
#define omega omega_pyr2pyrFENG
#define sfunc sfunc_pyr2pyrFENG
#define unirand unirand_pyr2pyrFENG
...
#define Beta2 Beta2_pyr2pyrFENG
 double Beta2 = 0.0001;
#define Beta1 Beta1_pyr2pyrFENG
 double Beta1 = 0.001;
#define DA_S DA_S_pyr2pyrFENG
 double DA_S = 1.3;
#define DA_t3 DA_t3_pyr2pyrFENG
 double DA_t3 = 0.9;
#define DA_t2 DA_t2_pyr2pyrFENG
 double DA_t2 = 0.8;
#define DA_t1 DA_t1_pyr2pyrFENG
 double DA_t1 = 1.2;
#define DAstop2 DAstop2_pyr2pyrFENG
 double DAstop2 = 36000;
#define DAstart2 DAstart2_pyr2pyrFENG
 double DAstart2 = 35900;
#define DAstop1 DAstop1_pyr2pyrFENG
 double DAstop1 = 40000;
#define DAstart1 DAstart1_pyr2pyrFENG
 ...
 "Beta1_pyr2pyrFENG", "/ms",
 "Beta2_pyr2pyrFENG", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_pyr2pyrFENG", &DAstart1_pyr2pyrFENG,
 "DAstop1_pyr2pyrFENG", &DAstop1_pyr2pyrFENG,
 "DAstart2_pyr2pyrFENG", &DAstart2_pyr2pyrFENG,
 "DAstop2_pyr2pyrFENG", &DAstop2_pyr2pyrFENG,
 "DA_t1_pyr2pyrFENG", &DA_t1_pyr2pyrFENG,
 "DA_t2_pyr2pyrFENG", &DA_t2_pyr2pyrFENG,
 "DA_t3_pyr2pyrFENG", &DA_t3_pyr2pyrFENG,
 "DA_S_pyr2pyrFENG", &DA_S_pyr2pyrFENG,
 "Beta1_pyr2pyrFENG", &Beta1_pyr2pyrFENG,
 "Beta2_pyr2pyrFENG", &Beta2_pyr2pyrFENG,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyr2pyrFENG /Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/x86_64/pyr2pyrFENG.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 167 in file pyr2pyrFENG.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/modfiles/pyr2pyrFENG.mod";
static const char* nmodl_file_text = 
  ":Pyramidal Cells to Pyramidal Cells AMPA+NMDA with local Ca2+ pool\n"
  ":pyrDpyrD_STFD from Feng 2019\n"
  "NEURON {\n"
  "	POINT_PROCESS pyr2pyrFENG\n"
  "	USEION ca READ eca	\n"
