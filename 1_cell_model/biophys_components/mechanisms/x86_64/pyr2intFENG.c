...
#define nrn_init _nrn_init__pyr2intFENG
#define _nrn_initial _nrn_initial__pyr2intFENG
#define nrn_cur _nrn_cur__pyr2intFENG
#define _nrn_current _nrn_current__pyr2intFENG
#define nrn_jacob _nrn_jacob__pyr2intFENG
#define nrn_state _nrn_state__pyr2intFENG
#define _net_receive _net_receive__pyr2intFENG 
#define release release__pyr2intFENG 
...
#define eta eta_pyr2intFENG
#define omega omega_pyr2intFENG
#define sfunc sfunc_pyr2intFENG
#define unirand unirand_pyr2intFENG
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyr2intFENG /Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/x86_64/pyr2intFENG.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 160 in file pyr2intFENG.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/modfiles/pyr2intFENG.mod";
static const char* nmodl_file_text = 
  ":Pyramidal Cells to Interneuron Cells AMPA+NMDA with local Ca2+ pool\n"
  ":pyrD2interD_STFD from Feng 2019\n"
  "NEURON {\n"
  "	POINT_PROCESS pyr2intFENG\n"
  "	USEION ca READ eca	\n"
