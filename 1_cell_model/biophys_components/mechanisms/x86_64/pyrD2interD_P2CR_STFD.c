...
#define nrn_init _nrn_init__pyrD2interD_P2CR_STFD
#define _nrn_initial _nrn_initial__pyrD2interD_P2CR_STFD
#define nrn_cur _nrn_cur__pyrD2interD_P2CR_STFD
#define _nrn_current _nrn_current__pyrD2interD_P2CR_STFD
#define nrn_jacob _nrn_jacob__pyrD2interD_P2CR_STFD
#define nrn_state _nrn_state__pyrD2interD_P2CR_STFD
#define _net_receive _net_receive__pyrD2interD_P2CR_STFD 
#define release release__pyrD2interD_P2CR_STFD 
...
#define eta eta_pyrD2interD_P2CR_STFD
#define omega omega_pyrD2interD_P2CR_STFD
#define sfunc sfunc_pyrD2interD_P2CR_STFD
#define unirand unirand_pyrD2interD_P2CR_STFD
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _pyrD2interD_P2CR_STFD_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrD2interD_P2CR_STFD /Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/x86_64/pyrD2interD_P2CR_STFD.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 162 in file pyrD2interD_P2CR_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/modfiles/pyrD2interD_P2CR_STFD.mod";
static const char* nmodl_file_text = 
