...
#define nrn_init _nrn_init__shock2int
#define _nrn_initial _nrn_initial__shock2int
#define nrn_cur _nrn_cur__shock2int
#define _nrn_current _nrn_current__shock2int
#define nrn_jacob _nrn_jacob__shock2int
#define nrn_state _nrn_state__shock2int
#define _net_receive _net_receive__shock2int 
#define release release__shock2int 
...
#define DA2 DA2_shock2int
#define DA1 DA1_shock2int
#define GAP1 GAP1_shock2int
#define NE2 NE2_shock2int
#define NEn NEn_shock2int
#define eta eta_shock2int
#define omega omega_shock2int
#define unirand unirand_shock2int
...
#define Beta2 Beta2_shock2int
 double Beta2 = 0.0001;
#define Beta1 Beta1_shock2int
 double Beta1 = 0.001;
#define DA_S DA_S_shock2int
 double DA_S = 1.6;
#define DA_t3 DA_t3_shock2int
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_shock2int
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_shock2int
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_shock2int
 double DAstop2 = 36000;
#define DAstart2 DAstart2_shock2int
 double DAstart2 = 35900;
#define DAstop1 DAstop1_shock2int
 double DAstop1 = 40000;
#define DAstart1 DAstart1_shock2int
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_shock2int
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_shock2int
 double GAPstart1 = 96000;
#define NE_S NE_S_shock2int
 double NE_S = 1;
#define NE_t3 NE_t3_shock2int
 double NE_t3 = 1;
#define NE_t2 NE_t2_shock2int
 double NE_t2 = 1;
#define NE_t1 NE_t1_shock2int
 double NE_t1 = 1;
#define NEstop2 NEstop2_shock2int
 double NEstop2 = 36000;
#define NEstart2 NEstart2_shock2int
 double NEstart2 = 35900;
#define NEstop1 NEstop1_shock2int
 double NEstop1 = 40000;
#define NEstart1 NEstart1_shock2int
 double NEstart1 = 39500;
#define k k_shock2int
 double k = 0.01;
 ...
 "k_shock2int", &k_shock2int,
 "GAPstart1_shock2int", &GAPstart1_shock2int,
 "GAPstop1_shock2int", &GAPstop1_shock2int,
 "DAstart1_shock2int", &DAstart1_shock2int,
 "DAstop1_shock2int", &DAstop1_shock2int,
 "DAstart2_shock2int", &DAstart2_shock2int,
 "DAstop2_shock2int", &DAstop2_shock2int,
 "DA_t1_shock2int", &DA_t1_shock2int,
 "DA_t2_shock2int", &DA_t2_shock2int,
 "DA_t3_shock2int", &DA_t3_shock2int,
 "DA_S_shock2int", &DA_S_shock2int,
 "Beta1_shock2int", &Beta1_shock2int,
 "Beta2_shock2int", &Beta2_shock2int,
 "NEstart1_shock2int", &NEstart1_shock2int,
 "NEstop1_shock2int", &NEstop1_shock2int,
 "NEstart2_shock2int", &NEstart2_shock2int,
 "NEstop2_shock2int", &NEstop2_shock2int,
 "NE_t1_shock2int", &NE_t1_shock2int,
 "NE_t2_shock2int", &NE_t2_shock2int,
 "NE_t3_shock2int", &NE_t3_shock2int,
 "NE_S_shock2int", &NE_S_shock2int,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 shock2int /Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/x86_64/shock2int.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 182 in file shock2int.mod:\n	 \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gregglickert/Documents/GitHub/PlasticityToy/1_cell_model/biophys_components/mechanisms/modfiles/shock2int.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  ":using this as shock2int syn cause didnt have shock GABA syn\n"
  "NEURON {\n"
  "	POINT_PROCESS shock2int\n"
